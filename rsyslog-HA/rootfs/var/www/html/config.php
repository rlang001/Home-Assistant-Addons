...
$CFG['SearchCustomButtonCaption'] = "Errors";	// Default caption for the custom fast search button
...
$CFG['Sources']['Source1']['ID'] = 'Source1';
$CFG['Sources']['Source1']['Name'] = 'SQLDB';
$CFG['Sources']['Source1']['ViewID'] = 'SYSLOG';
