...
config['StdReport']['HTML_ROOT'] = "/var/www/html/reports"
# config['StdReport']['enable'] = "false"

config['StdReport']['SeasonsReport']['HTML_ROOT'] = "/var/www/html/reports/seasons"
config['StdReport']['SeasonsReport']['enable'] = "true"

config['StdReport']['SmartphoneReport']['HTML_ROOT'] = "/var/www/html/reports/smartphone"
config['StdReport']['SmartphoneReport']['enable'] = "true"

config['StdReport']['MobileReport']['HTML_ROOT'] = "/var/www/html/reports/mobile"
config['StdReport']['MobileReport']['enable'] = "true"

config['StdReport']['NWSReport']['HTML_ROOT'] = "/var/www/html/reports/nws"
config['StdReport']['NWSReport']['enable'] = "true"

config['StdReport']['Belchertown']['HTML_ROOT'] = "/var/www/html/reports/belchertown"
config['StdReport']['Belchertown']['enable'] = "true"

config['StdReport']['amphibian']['HTML_ROOT'] = "/var/www/html/reports/amphibian"
config['StdReport']['amphibian']['enable'] = "true"

config['StdReport']['WdcReport']['HTML_ROOT'] = "/var/www/html/reports/wdc"
config['StdReport']['WdcReport']['enable'] = "true"

config['StdReport']['simple']['HTML_ROOT'] = "/var/www/html/reports/simple"
config['StdReport']['simple']['enable'] = "true"

config['StdReport']['SteelSeries']['HTML_ROOT'] = "/var/www/html/reports/ss"
...
config['StdReport']['NeoWX-Material']['HTML_ROOT'] = "/var/www/html/reports/neowxmaterial"
