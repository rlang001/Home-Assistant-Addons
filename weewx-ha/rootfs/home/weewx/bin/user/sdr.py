...
class SpringfieldSoilPacket(Packet):
    # {"time" : "2023-04-16 08:16:32", "model" : "Springfield-Soil", "id" : 199, "channel" : 1, "battery_ok" : 1, "transmit" : "MANUAL", "temperature_C" : 20.80, "moisture" : 0, "button" : 0 "mic" : "CHECKSUM"}

    IDENTIFIER = "Springfield-Soil"
    ...
    def parse_json(obj):
        ...
        pkt['channel'] = obj.get('channel')
        pkt['transmit'] = obj.get('transmit')
        pkt = Packet.add_identifiers(pkt, sensor_id, SpringfieldSoilPacket.__name__)
        return pkt
